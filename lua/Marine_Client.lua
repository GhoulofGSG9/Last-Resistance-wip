...
elseif weapon and weapon:isa("LayJetpack") then
    
		self.currentTechId = kTechId.Jetpack
        self.ghostStructureCoords = weapon:GetGhostModelCoords()
        self.ghostStructureValid = weapon:GetIsPlacementValid()
        self.showGhostModel = weapon:GetShowGhostModel()
        
elseif weapon and weapon:isa("LayExosuit") then
    
		self.currentTechId = kTechId.Exosuit
        self.ghostStructureCoords = weapon:GetGhostModelCoords()
        self.ghostStructureValid = weapon:GetIsPlacementValid()
        self.showGhostModel = weapon:GetShowGhostModel()
        

elseif weapon and weapon:isa("LayDualRailgunExosuit") then
    
		self.currentTechId = kTechId.DualMinigunExosuit
        self.ghostStructureCoords = weapon:GetGhostModelCoords()
        self.ghostStructureValid = weapon:GetIsPlacementValid()
       self.showGhostModel = weapon:GetShowGhostModel()
