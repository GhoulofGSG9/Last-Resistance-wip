...
function Marine:OnCreate()
    ...
    self.unlockedWeapons = {kTechId.LayJetpack}
    self.unlockedWeapons = {kTechId.LayDualRailgunExosuit}
...
function Marine:OnUpdateUpgradeLevel( newLevel )
