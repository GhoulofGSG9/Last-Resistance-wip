...
local kShadowStepForce = 10

local kShadowStepSpeed = 10

local kMaxSpeed = 6.2
local kBlinkSpeed = 30
local kBlinkAcceleration = 60
...
function Fade:ModifyAttackSpeed(attackSpeedTable)
    attackSpeedTable.attackSpeed = attackSpeedTable.attackSpeed * 2.7
end
