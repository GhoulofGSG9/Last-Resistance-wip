...
function BuildTechData()
    ...
    local techData = { 
     ...
     // { [kTechDataId] = kTechId.DropDualRailgunExosuit,   [kTechDataMapName] = DualRailgunExosuit.kMapName, [kTechDataDisplayName] = "DUALRAILGUN_EXOSUIT", [kTechIDShowEnables] = false, [kTechDataTooltipInfo] =  "DUALRAILGUN_EXOSUIT", [kTechDataModel] = DualRailgunExosuit.kModelName, [kTechDataCostKey] = kExosuitDropCost, [kStructureAttachId] = kTechId.PrototypeLab, [kStructureAttachRange] = kArmoryWeaponAttachRange, [kStructureAttachRequiresPower] = true },
        ...
        { [kTechDataId] = kTechId.LayJetpack,    [kTechDataMapName] = LayJetpack.kMapName,         [kTechDataHint] = "JETPACK",		[kTechDataDisplayName] = "JETPACK",   [kTechDataTooltipInfo] = "JETPACK_TOOLTIP",		[kTechDataModel] = Jetpack.kModelName,      [kTechDataCostKey] = kMineCost }, 
    //  { [kTechDataId] = kTechId.LayDualRailgunExosuit,    [kTechDataMapName] = LayDualRailgunExosuit.kMapName,         [kTechDataHint] = "DUALRAILGUN_EXOSUIT",		[kTechDataDisplayName] = "DUALRAILGUN_EXOSUIT",   [kTechDataTooltipInfo] = "DUALRAILGUN_EXOSUIT_TOOLTIP",		[kTechDataModel] = DualRailgunExosuit.kModelName,      [kTechDataCostKey] = kMineCost }, 
    //  { [kTechDataId] = kTechId.LayCatpack,    [kTechDataMapName] = LayCatpack.kMapName,         [kTechDataHint] = "CAT_PACK",		[kTechDataDisplayName] = "CAT_PACK",   [kTechDataTooltipInfo] = "CAT_PACK_TOOLTIP",		[kTechDataModel] = Catpack.kModelName,      [kTechDataCostKey] = kMineCost }, 
        { [kTechDataId] = kTechId.LayExosuit,    [kTechDataMapName] = LayExosuit.kMapName,         [kTechDataHint] = "EXOSUIT",		[kTechDataDisplayName] = "EXOSUIT",   [kTechDataTooltipInfo] = "EXOSUIT_TOOLTIP",		[kTechDataModel] = Exosuit.kModelName,      [kTechDataCostKey] = kMineCost }, 
         
        // Armor and upgrades
        { [kTechDataId] = kTechId.Jetpack,   [kTechDataMapName] = Jetpack.kMapName,                   [kTechDataDisplayName] = "JETPACK", [kTechDataGhostModelClass] = "MarineGhostModel", [kTechDataModel] = Jetpack.kModelName, [kTechDataCostKey] = kJetpackCost, [kTechDataSpawnHeightOffset] = kCommanderEquipmentDropSpawnHeight },
        ...
        { [kTechDataId] = kTechId.Exosuit,           [kTechDataDisplayName] = "EXOSUIT", [kTechDataMapName] = "exo", [kTechDataGhostModelClass] = "MarineGhostModel", [kTechDataModel] = Exosuit.kModelName,               [kTechDataCostKey] = kExosuitCost, [kTechDataHotkey] = Move.E, [kTechDataTooltipInfo] = "EXOSUIT_TECH_TOOLTIP", [kTechDataSpawnHeightOffset] = kCommanderEquipmentDropSpawnHeight},
        ...
        { [kTechDataId] = kTechId.Hallucinate,  [kTechDataCooldown] = 0,   [kTechDataMapName] = HallucinationCloud.kMapName, [kTechDataDisplayName] = "HALLUCINATION_CLOUD", [kTechDataCostKey] = kHallucinationCloudCost, [kTechDataTooltipInfo] =  "HALLUCINATION_CLOUD_TOOLTIP"},
