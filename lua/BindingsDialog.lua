...
local globalControlBindings = {
    "Movement", "title", Locale.ResolveString("BINDINGS_MOVEMENT"), "",
    ...
    "Action", "title", Locale.ResolveString("BINDINGS_ACTION"), "",
    ...
    "LastUpgrades", "input", Locale.ResolveString("BINDINGS_EVOLVE_LAST_UPGRADES"), "",
    ...
    "ToggleMinimapNames", "input", Locale.ResolveString("BINDINGS_TOGGLE_MINIMAP_NAMES"), "",
    ...
    "Weapon6", "input", Locale.ResolveString("BINDINGS_WEAPON_#6"), "6",
	"Weapon7", "input", Locale.ResolveString("BINDINGS_WEAPON_#7"), "7",
	"Weapon8", "input", Locale.ResolveString("BINDINGS_WEAPON_#8"), "8",
	"Weapon9", "input", Locale.ResolveString("BINDINGS_WEAPON_#9"), "9",
...
local globalComControlBindings = {
    "Grid1", "input", Locale.ResolveString("COMBINDINGS_GRID_SPOT_1_(DEFAULT_Q)"), "U",
    ...
    "Grid10", "input", Locale.ResolveString("COMBINDINGS_GRID_SPOT_10_(DEFAULT_C)"), "C",
